 ...
 * function:
 */
public class HomeReXiaoShengPinAdapter extends RecyclerView.Adapter<HomeReXiaoShengPinAdapter.ViewHodler> {
    Context mContext;
    List<HomeBean.ResultBean.RxxpBean.CommodityListBean> list;

    public HomeReXiaoShengPinAdapter(Context context) {
        mContext = context;
        list=new ArrayList<>();
    }
    public void setData(List<HomeBean.ResultBean.RxxpBean.CommodityListBean> shouYeZhanShiBean) {
