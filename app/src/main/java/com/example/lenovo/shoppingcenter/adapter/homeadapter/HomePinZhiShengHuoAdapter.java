 ...
 * function:
 */
public class HomePinZhiShengHuoAdapter extends RecyclerView.Adapter<HomePinZhiShengHuoAdapter.ViewHodler> {
    Context mContext;
    List<HomeBean.ResultBean.PzshBean.CommodityListBeanX> list;

    public HomePinZhiShengHuoAdapter(Context context) {
        mContext = context;
        list=new ArrayList<>();
    }
    public void setData(List<HomeBean.ResultBean.PzshBean.CommodityListBeanX> shouYeZhanShiBean) {
    ...
    public ViewHodler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=View.inflate(mContext, R.layout.fragment_shouye_rexiaoshangpin,null);
